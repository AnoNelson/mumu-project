...
return '<li '+link+' data-option data-value="'+el.value+'"><span '+optclass+'>'+el.textContent+'</span></li>';};[].slice.call(this.el.children).forEach(function(el){if(el.disabled){return;}
...
SelectFx.prototype._isDisabled=function(opt){return classie.has(this.selEl,'cs-select-disabled');}
